...
const Collectible = require("../public/Collectible.cjs");
const Player = require("../public/Player.cjs");
...
describe("Unit Tests", () => {
	...
	describe("Collectible class", () => {
		it("Collectible class generates a collectible item object.", (done) => {
		...
		it("Collectible item object contains x and y coordinates and a unique id.", (done) => {
			const testItem = new Collectible({ x: 100, y: 100, id: Date.now() });
	...
	describe("Player class", () => {
		it("Player class generates a player object.", (done) => {
		...
		it("Player object contains a score, x and y coordinates, and a unique id.", (done) => {
			const testPlayer = new Player({
				x: 100,
				y: 100,
				score: 0,
		...
		it("movePlayer(str, num) adjusts a player's position.", (done) => {
		...
		it("collision(obj) returns true when a player's avatar collides with a collectible item object.", (done) => {
		...
		it("calculateRank(arr) returns the player's rank string.", (done) => {
